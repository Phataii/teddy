        ...
        <main class="">
          ...
          <div className="grid grid-cols-4">
            ...
            <div className="col-span-3">
              <div className="">
              <img
                      src={require("../../images/abc.jpg").default}
                      alt="BTC"
